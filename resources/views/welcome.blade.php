    ...
    <body>
        <div class="row">
            <div class="col-xs-12" style="height:100%;">
                <iframe class="col-sm-12 hidden-sm hidden-md hidden-lg"width="560" height="315" src="https://www.youtube.com/embed/9rDMz5vJfFk" frameborder="0" allowfullscreen></iframe>
